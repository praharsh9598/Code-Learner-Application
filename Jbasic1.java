...
import android.widget.Toast;
  ...
  public class Jbasic1 extends Activity implements RadioGroup.OnCheckedChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.jbasic1);

        n =getIntent().getExtras().getString("name");

        Mysqlhelper helper=new Mysqlhelper(Jbasic1.this);

        final SQLiteDatabase db=helper.getWritableDatabase();

        no=Integer.parseInt(getIntent().getStringExtra("topic"));
        jque=(TextView) findViewById(R.id.jtxtquestion);
        jrg=(RadioGroup) findViewById(R.id.jquerg);
        jnxt=(Button) findViewById(R.id.jbtnnextque);
        mc1=(RadioButton) findViewById(R.id.jbradio0);
        mc2=(RadioButton) findViewById(R.id.jbradio1);
        mc3=(RadioButton) findViewById(R.id.jbradio2);
        mc4=(RadioButton) findViewById(R.id.jbradio3);

        jrg.setOnCheckedChangeListener(this);
        TextView arr1 = (TextView)findViewById(R.id.mcqnum);
        arr1.setText("MCQ: "+Integer.toString(no-8)+"/4");
        ...
        jnxt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(flag==1)
                {
                    ...
                    Intent i;
                    if(no>12) {
                        i = new Intent(Jbasic1.this, Javalearon.class);
                        Toast.makeText(Jbasic1.this, "Basic Section Completed", Toast.LENGTH_SHORT).show();
                    }
                    else
                        i=new Intent(Jbasic1.this,Jbasic.class);
                    flag=0;
                ...
                {
                    Toast.makeText(Jbasic1.this,"Wrong answer", Toast.LENGTH_SHORT).show();
                }
            }
        });
...
*/
      ...
      public void goHome(View v){
          Intent i = new Intent(Jbasic1.this, Learn.class);
          i.putExtra("name",n);
          startActivity(i);
      }
}
