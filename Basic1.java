...
public class Basic1 extends Activity implements OnCheckedChangeListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		arr1.setText("MCQ: "+Integer.toString(no-0)+"/4");
			...
			if(flag==1)
			{
				...
				Intent i;
				 if(no>4){
					 ...
					 Toast.makeText(Basic1.this, "Basic Section Completed", Toast.LENGTH_SHORT).show();
...
public void goHome(View v){
	Intent i = new Intent(Basic1.this, Learn.class);
	i.putExtra("name",n);
	startActivity(i);
}
